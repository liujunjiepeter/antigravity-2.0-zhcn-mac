...
def main():
    ...
    translations = {
        ...
        '"Delete Project"': '"删除项目"',
        '"Open"': '"打开"',
        'displayName:"Unrestricted"': 'displayName:"无限制"',
        'displayName:"Sandboxed"': 'displayName:"沙箱模式"',
        'displayName:"Strict"': 'displayName:"严格模式"',
        'displayName:"Turbo mode"': 'displayName:"极速模式"',
        'displayName:"Default"': 'displayName:"默认"',
        'displayName:"Full machine"': 'displayName:"完整主机"',
        '"Turbo mode"': '"极速模式"',
        '"Full machine"': '"完整主机"',
        ...
        '"Set the speed of tab suggestions"': '"设置 Tab 建议 of 显示速度。"',
